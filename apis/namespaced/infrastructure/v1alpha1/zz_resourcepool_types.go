...
type ResourcePoolInitParameters struct {
	...
	// (String) The description of the resource pool.
	// The description of the resource pool.
	Description *string `json:"description,omitempty" tf:"description,omitempty"`

	// (String) The name of the resource pool.
...
// ResourcePool is the Schema for the ResourcePools API. Provides a resource to manage MAAS resource pools.
