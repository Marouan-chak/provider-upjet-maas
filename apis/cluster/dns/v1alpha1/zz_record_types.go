...
type RecordInitParameters struct {
	...
	// (String) The data set for the new DNS record.
	...
	// +crossplane:generate:reference:type=github.com/Marouan-chak/provider-upjet-maas/apis/cluster/dns/v1alpha1.Domain
	...
	// (String) The fully qualified domain name of the new DNS record. This contains the name and the domain of the new DNS record. It conflicts with name and domain arguments.
	...
	// (String) The new DNS record resource name. Used in conjunction with domain. It conflicts with fqdn argument.
	// The new DNS record resource name. Used in conjunction with `domain`. It conflicts with `fqdn` argument.
	Name *string `json:"name,omitempty" tf:"name,omitempty"`

	// (Number) The TTL of the new DNS record.
	// The TTL of the new DNS record.
	TTL *float64 `json:"ttl,omitempty" tf:"ttl,omitempty"`

	// (String) The DNS record type. Valid options are: A/AAAA, CNAME, MX, NS, SRV, SSHFP, TXT.
...
// Record is the Schema for the Records API. Provides a resource to manage MAAS DNS domain records.
